...
Sexual language and imagery is not appropriate for any communication and/or talks. Be kind and do not insult or put down others. Behave professionally. Remember that harassment and sexist, racist, or exclusionary jokes are not appropriate for Emplea.do Community. Staff violating these rules should be reported to an appropriate line manager.

These are the values to which people in the Emplea.do community should aspire:
...
Incidents that violate the Code of Conduct are extremely damaging to the Emplea.do Community, and they will not be tolerated. The silver lining is that, in many cases, these incidents present a chance for the offenders, and the teams at large, to grow, learn, and become better.
...
- Depending on the severity/details of the incident, removing a harasser from membership of relevant Emplea.do Community organisations
...
This Code of Conduct was adapted from [Integralist](https://gist.github.com/Integralist/4e84af31c483d0f5a182), [Golang](https://golang.org/conduct) an the [Golang UK Conference](http://golanguk.com/conduct/).
